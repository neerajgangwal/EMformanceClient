...
function MyTaskComponent_li_33_Template(rf, ctx) { if (rf & 1) {
...
class MyTaskComponent {
    constructor(taskservice, layoutservice, searchservice, fb) {
...
MyTaskComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MyTaskComponent, selectors: [["app-my-task"]], decls: 74, vars: 2, consts: [[1, "main-panel"], [1, "content"], [1, "container-fluid"], [1, "row"], [1, "col-md-8"], [1, "top-heading"], [1, "col-md-2"], [1, "dropdown"], ["id", "dropdownMenuButton", "type", "button", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "btn-primary", "dropdown-toggle"], [1, "caret"], ["aria-labelledby", "dropdownMenuButton", 1, "dropdown-menu"], ["href", "javascript:void(0);", 1, "dropdown-item"], ["type", "submit", "value", "Create Task", 1, "team", "btn", "btn-primary"], [1, "emlist"], [1, "team-member", "team-listvew"], [1, "mytask-heading"], ["class", "mytask-heading list-content", 4, "ngFor", "ngForOf"], ["id", "add-task", 1, "slide-popup"], [1, "slide-close"], ["aria-hidden", "true", 1, "fa", "fa-angle-left"], [1, "slide-content"], [3, "formGroup"], [1, "form-group"], ["for", ""], ["type", "text", "formControlName", "taskHeading", "placeholder", "Enter task title here", 1, "form-control"], ["Class", "form-control", "formControlName", "taskDescription", "rows", "4", "cols", "50", "placeholder", " Enter Task details here"], [1, "file-upload"], ["type", "text", "formControlName", "taskAttachment", "readonly", "", "placeholder", "File details here", 1, "form-control"], [1, "input-group-btn"], [1, "file-upload", "btn", "btn-success"], ["id", "upload", 1, "upl"], ["type", "file", "id", "up", 1, "upload", "up"], [1, "col-md-5"], ["type", "date", "formControlName", "taskStartDate", 1, "form-control"], [1, "col-md-2", "text-center"], [1, "to-padding"], ["type", "date", "formControlName", "taskDueDate", 1, "form-control"], ["type", "submit", "value", "CREATE TASK", 1, "btn", "btn-primary", 3, "click"], [1, "mytask-heading", "list-content"], [1, "prioritybox", "redcolor"], [1, "icon-View"]], template: function MyTaskComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MyTaskComponent_Template_input_click_73_listener() { return ctx.CreateTask(ctx.taskgroup.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MyTaskComponent, [{
    ...
    }], function () { return [{ type: _task_service__WEBPACK_IMPORTED_MODULE_3__["TaskService"] }, { type: _Services_layout_service__WEBPACK_IMPORTED_MODULE_4__["LayoutService"] }, { type: _Services_search_service__WEBPACK_IMPORTED_MODULE_5__["SearchService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }]; }, null); })();
...
const routes = [{ path: 'team-task', component: _team_task_team_task_component__WEBPACK_IMPORTED_MODULE_3__["TeamTaskComponent"] },
    { path: 'my-task', component: _my_task_my_task_component__WEBPACK_IMPORTED_MODULE_2__["MyTaskComponent"] }];
...
function TeamTaskComponent_li_34_Template(rf, ctx) { if (rf & 1) {

...
/* harmony import */ var _team_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../team.service */ "./src/app/Features/team/team.service.ts");
...
function TeamListComponent_li_17_Template(rf, ctx) { if (rf & 1) {
...
class TeamListComponent {
    constructor(teamservice, fb, layoutservice, searchservice) {
...
TeamListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TeamListComponent, selectors: [["app-team-list"]], decls: 18, vars: 1, consts: [[1, "main-panel"], [1, "content"], [1, "container-fluid"], [1, "row"], [1, "col-md-10"], [1, "top-heading"], [1, "col-md-2"], ["type", "submit", "value", "Create Team", 1, "team", "btn", "btn-primary"], [1, "emlist"], [1, "team-member", "team-listvew"], [1, "team-heading"], ["class", "team-heading list-content", 4, "ngFor", "ngForOf"], [1, "team-heading", "list-content"], [1, "icon-View"], [1, "icon-edit"], [1, "icon-Delete"]], template: function TeamListComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TeamListComponent, [{
    ...
    }], function () { return [{ type: _team_service__WEBPACK_IMPORTED_MODULE_1__["TeamService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: _Services_layout_service__WEBPACK_IMPORTED_MODULE_3__["LayoutService"] }, { type: _Services_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchService"] }]; }, null); })();
...
const routes = [{ path: 'list', component: _team_list_team_list_component__WEBPACK_IMPORTED_MODULE_2__["TeamListComponent"] }];

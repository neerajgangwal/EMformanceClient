...
/* harmony import */ var _department_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../department.service */ "./src/app/Features/department/department.service.ts");
...
function CreateDepartmentComponent_li_26_Template(rf, ctx) { if (rf & 1) {
...
class CreateDepartmentComponent {
    constructor(fb, AddDept, layoutservice, messageService, searchService) {
        this.fb = fb;
...
CreateDepartmentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CreateDepartmentComponent, selectors: [["app-create-department"]], decls: 27, vars: 2, consts: [[1, "main-panel"], [1, "content"], [1, "container-fluid"], [1, "row"], [1, "col-md-4"], [1, "top-heading"], [1, "form-container", 3, "formGroup"], [1, "form-section"], [1, "col-lg-6"], [1, "form-group"], ["for", ""], ["type", "text", "placeholder", "Enter Department Name", "formControlName", "departmentName", 1, "form-control"], [1, "col-lg-3", "pull-left"], [1, "subbtn", "btn", "btn-primary", 3, "click"], [1, "emlist"], [1, "team-member", "team-listvew"], [1, "list-heading"], [1, "dpname"], ["class", "list-heading list-content", 4, "ngFor", "ngForOf"], [1, "list-heading", "list-content"], [1, "icon-edit"], [1, "icon-Delete"]], template: function CreateDepartmentComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateDepartmentComponent_Template_button_click_16_listener() { return ctx.CreateButtonClicked(ctx.DepartmentForm.value); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreateDepartmentComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _department_service__WEBPACK_IMPORTED_MODULE_2__["DepartmentService"] }, { type: _Services_layout_service__WEBPACK_IMPORTED_MODULE_3__["LayoutService"] }, { type: primeng_api__WEBPACK_IMPORTED_MODULE_4__["MessageService"] }, { type: _Services_search_service__WEBPACK_IMPORTED_MODULE_5__["SearchService"] }]; }, null); })();
...
const routes = [{ path: 'create', component: _create_department_create_department_component__WEBPACK_IMPORTED_MODULE_2__["CreateDepartmentComponent"] }];

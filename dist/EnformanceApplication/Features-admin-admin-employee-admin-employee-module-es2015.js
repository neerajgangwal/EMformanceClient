...
/* harmony import */ var _admin_employee_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admin-employee.component */ "./src/app/Features/admin/admin-employee/admin-employee.component.ts");
...
AdminEmployeeRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AdminEmployeeRoutingModule_Factory(t) { return new (t || AdminEmployeeRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
...
AdminEmployeeComponent.ɵfac = function AdminEmployeeComponent_Factory(t) { return new (t || AdminEmployeeComponent)(); };
AdminEmployeeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminEmployeeComponent, selectors: [["app-admin-employee"]], decls: 2, vars: 0, template: function AdminEmployeeComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _admin_employee_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admin-employee-routing.module */ "./src/app/Features/admin/admin-employee/admin-employee-routing.module.ts");
/* harmony import */ var _admin_employee_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./admin-employee.component */ "./src/app/Features/admin/admin-employee/admin-employee.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AdminEmployeeModule, { declarations: [_admin_employee_component__WEBPACK_IMPORTED_MODULE_3__["AdminEmployeeComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _admin_employee_routing_module__WEBPACK_IMPORTED_MODULE_2__["AdminEmployeeRoutingModule"]] }); })();
...
//# sourceMappingURL=Features-admin-admin-employee-admin-employee-module-es2015.js.map
...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Features-signup-signup-module"], {
  ...
  /***/
  function srcAppFeaturesSignupEmailVerificationEmailVerificationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Entities_EmployeePermissions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../../Entities/EmployeePermissions */
    "./src/app/Entities/EmployeePermissions.ts");
    /* harmony import */


    var _Entities_EmployeeRoleElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../Entities/EmployeeRoleElement */
    "./src/app/Entities/EmployeeRoleElement.ts");
    /* harmony import */


    var _Entities_ElementOperation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../../Entities/ElementOperation */
    ...
    var _signup_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../signup.service */
    ...
    function EmailVerificationComponent_div_9_i_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i", 12);
      }
    }

    function EmailVerificationComponent_div_9_i_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EmailVerificationComponent = /*#__PURE__*/function () {
      function EmailVerificationComponent(route, signupService, router) {
      ...
      _createClass(EmailVerificationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParamMap.subscribe(function (params) {
            ...
            _this.signupService.ValidateToken(token).subscribe(function (res) {
              if (res.errorCode == 0) {
                _this.signupService.getElements(res.dataObj.companyInfo).subscribe(function (res1) {
                  if (res1.errorCode == 0) {
                    _this.ElementsData = res1.dataObj;

                    _this.signupService.getOperations(res.dataObj.companyInfo).subscribe(function (res2) {
                      if (res2.errorCode == 0) {
                        _this.OperationsData = res2.dataObj;

                        var empData = _this.GetEmpData(res.dataObj);

                        _this.signupService.CreateEmployee(res.dataObj.companyInfo, empData).subscribe(function (res3) {
                          if (res3.errorCode == 0) {
                            _this.loading = false;
                            _this.message = "Successfully verified";
                            _this.verified = true;
                ...
                _this.message = "Failed to verified, please try again";
              }
            }, function (error) {
              _this.loading = false;
              _this.verified = false;
        ...
        key: "GetEmpData",
        value: function GetEmpData(data) {
          ...
          for (var index = 0; index < this.ElementsData.length; index++) {
            var ele = this.ElementsData[index];
            ...
            for (var index2 = 0; index2 < this.OperationsData.length; index2++) {
              var ops = this.OperationsData[index2];
    ...
    EmailVerificationComponent.ɵfac = function EmailVerificationComponent_Factory(t) {
      return new (t || EmailVerificationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_signup_service__WEBPACK_IMPORTED_MODULE_5__["SignupService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmailVerificationComponent, [{
        ...
        return [{
          ...
          type: _signup_service__WEBPACK_IMPORTED_MODULE_5__["SignupService"]
        }, {
  ...
  function srcAppFeaturesSignupSignupRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var routes = [{
      ...
      component: _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_3__["EmailVerificationComponent"],
      data: {
        Title: '',
        ShowHeader: false,
        ShowNavBar: false
  ...
  function srcAppFeaturesSignupSignupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SignupComponent_form_14_span_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SignupComponent_form_14_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_29_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_47_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_64_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_span_69_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 46);
    ...
    function SignupComponent_form_14_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SignupComponent_form_14_Template_form_ngSubmit_0_listener() {
          ...
          return ctx_r11.OnSubmit(ctx_r11.SignupForm.value);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("blur", function SignupComponent_form_14_Template_input_blur_28_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r13.checkPortalName(ctx_r13.SignupForm.controls["portalName"].value);
        });
    ...
    var SignupComponent = /*#__PURE__*/function () {
      function SignupComponent(layoutservice, fb, signupService, router, messageService) {
        ...
        this.OnSubmit = function (data) {
          ...
          this.signupService.SignupFunction(userData).subscribe(function (res) {
            if (res.errorCode == 0) {
              var company = {
              ...
              _this2.signupService.addCompany(company).subscribe(function (res) {
                if (res.errorCode == 0) {
                  _this2.messageService.add({
                    severity: 'success',
                    summary: "Comapny added successfully"
                  });

                  _this2.ShowValidationMessage = true;
                } else {
                  _this2.messageService.add({
                    severity: 'error',
                ...
                _this2.messageService.add({
                  severity: 'error',
                  summary: "Something went wrong, please try later"
                });
              });
            } else {
              _this2.messageService.add({
      ...
      _createClass(SignupComponent, [{
        ...
        key: "checkPortalName",
        value: function checkPortalName(data) {
          var _this4 = this;

          this.signupService.CheckPortalName(data).subscribe(function (res) {
            if (res.errorCode == 0) {
              _this4.ShowCompanyValidationMessage = false;
            } else {
              _this4.ShowCompanyValidationMessage = true;
            }
          }), function (err) {};
        }
      }]);
  ...
  function srcAppFeaturesSignupSignupModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _email_verification_email_verification_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./email-verification/email-verification.component */
    "./src/app/Features/signup/email-verification/email-verification.component.ts");
    /* harmony import */
    ...
    SignupModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _signup_routing_module__WEBPACK_IMPORTED_MODULE_2__["SignupRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], primeng_progressbar__WEBPACK_IMPORTED_MODULE_6__["ProgressBarModule"]]]
    });
  ...
  function srcAppFeaturesSignupSignupServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupService = function SignupService(httpClient, userService) {
    ...
    SignupService.ɵfac = function SignupService_Factory(t) {
      return new (t || SignupService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_Services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]));
    };

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Features-login-login-module"], {
  ...
  function srcAppFeaturesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Entities_User__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../Entities/User */
      ...
      function LoginComponent(fb, loginService, layoutService, router, messageService) {
        ...
        this.onSubmit = function (data) {
          ...
          this.loginService.LoginFunction(data).subscribe(function (res) {
            if (res.errorCode == 0) {
              _this.loginService.getEmployee(res.dataObj.email, res.dataObj.companyInfo).subscribe(function (res2) {
                if (res2.errorCode == 0) {
                  _this.loginService.getPermissions(res.dataObj.companyInfo, res2.dataObj[0].employeeId).subscribe(function (res3) {
                    if (res3.errorCode == 0) {
  ...
  function srcAppFeaturesLoginLoginServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginService = function LoginService(httpClient, userService) {
      ...
      this.getCompany = function (email) {
        return this.httpClient.post(this.url + _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].getCompany, {
          adminEmail: email
        });
      };
      ...
      this.getEmployee = function (email, portalName) {
        return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].urlPrefix + portalName + _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].urlSuffix + _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].getEmployeeData, {
          employeeEmail: email
        });
      };
    };
    ...
    LoginService.ɵfac = function LoginService_Factory(t) {
      return new (t || LoginService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_Services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]));
    };
